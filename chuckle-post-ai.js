...
function ChucklePostAI(AI_option) {
  ...
  function MAIN(AI_option) {
    ...
    post_ai_box.innerHTML = `<div class="ai-title">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="21px" height="fit-content" viewBox="0 0 48 48">
